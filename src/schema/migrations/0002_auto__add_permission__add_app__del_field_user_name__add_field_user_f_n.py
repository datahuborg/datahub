...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('permissions', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schema.User'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schema.App'])),
            ('access', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('schema', ['Permission'])
        ...
        db.send_create_signal('schema', ['App'])
    ...
    models = {
        'schema.app': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schema.User']"})
        },
        'schema.permission': {
            'Meta': {'object_name': 'Permission', 'db_table': "'permissions'"},
            'access': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schema.App']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schema.User']"})
        },
