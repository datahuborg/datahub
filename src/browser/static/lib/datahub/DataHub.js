...
DataHubClient.prototype.open_connection = function(con_params) {
  this.send_open_connection(con_params);
  return this.recv_open_connection();
};

DataHubClient.prototype.send_open_connection = function(con_params) {
...
DataHubClient.prototype.create_repo = function(con, repo_name) {
  this.send_create_repo(con, repo_name);
  return this.recv_create_repo();
};

DataHubClient.prototype.send_create_repo = function(con, repo_name) {
...
DataHubClient.prototype.delete_repo = function(con, repo_name, force_if_non_empty) {
  this.send_delete_repo(con, repo_name, force_if_non_empty);
  return this.recv_delete_repo();
};

DataHubClient.prototype.send_delete_repo = function(con, repo_name, force_if_non_empty) {
...
DataHubClient.prototype.list_tables = function(con, repo_name) {
  this.send_list_tables(con, repo_name);
  return this.recv_list_tables();
};

DataHubClient.prototype.send_list_tables = function(con, repo_name) {
...
DataHubClient.prototype.close_connection = function(con) {
  this.send_close_connection(con);
  return this.recv_close_connection();
};

DataHubClient.prototype.send_close_connection = function(con) {
