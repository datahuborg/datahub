...
DataHubClient.prototype.print_schema = function(con, table_name, callback) {
  this.send_print_schema(con, table_name, callback); 
  if (!callback) {
    return this.recv_print_schema();
  }
};

DataHubClient.prototype.send_print_schema = function(con, table_name, callback) {
