...
ConnectionParams.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.repo_owner = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ConnectionParams.prototype.write = function(output) {
  ...
  if (this.repo_owner !== null && this.repo_owner !== undefined) {
    output.writeFieldBegin('repo_owner', Thrift.Type.STRING, 5);
    output.writeString(this.repo_owner);
    output.writeFieldEnd();
  }
  if (this.repo !== null && this.repo !== undefined) {
    output.writeFieldBegin('repo', Thrift.Type.STRING, 6);
...
Connection.prototype.write = function(output) {
  ...
  if (this.repo_owner !== null && this.repo_owner !== undefined) {
    output.writeFieldBegin('repo_owner', Thrift.Type.STRING, 4);
    output.writeString(this.repo_owner);
    output.writeFieldEnd();
  }
  if (this.repo !== null && this.repo !== undefined) {
    output.writeFieldBegin('repo', Thrift.Type.STRING, 5);
    output.writeString(this.repo);
    output.writeFieldEnd();
  }
