...
this["DataQ"]["templates"]["dq-filter-list-item"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<!-- HTML for filter in list of filters displayed in main DataQ container -->\n<li class=\"dq-filter-list-item\">\n  <div class=\"btn-group\" role=\"group\" aria-label=\"...\" data-code=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.filter : depth0)) != null ? stack1.code : stack1), depth0))
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.filter : depth0)) != null ? stack1.filter_string : stack1), depth0))
    + "</span></button>\n  </div>\n</li>\n";
},"useData":true});
this["DataQ"]["templates"]["dq-filter-modal"] = Handlebars.template({"1":function(depth0,helpers,partials,data,blockParams,depths) {
    var alias1=this.lambda, alias2=this.escapeExpression;

  return "              <li><a href=\"#\" class=\"dq-filter-1-link\" data-columnname=\""
    + alias2(alias1((depth0 != null ? depth0.column_name : depth0), depth0))
    + "\" data-reponame=\""
    + alias2(alias1((depths[1] != null ? depths[1].repo : depths[1]), depth0))
    + "\" data-tablename=\""
    + alias2(alias1((depth0 != null ? depth0.table_name : depth0), depth0))
    + "\">"
    + alias2(alias1((depth0 != null ? depth0.full_name : depth0), depth0))
    + "</a></li>\n";
  ...
  return "<!-- Modal HTML for adding a filter -->\n<div class=\"modal fade\" id=\"dq-filter-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close dq-filter-quit\" data-dismiss=\"modal\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n\n        <!-- Title indicating that this modal is for creating filters -->\n        <h4 class=\"modal-title\">Create a Filter</h4>\n      </div>\n\n      <!-- Modal body -->\n      <div class=\"modal-body row form-inline filter-modal-body\">\n\n        <!-- The first dropdown where the user can specify <val1> in the filter <val1> <operation> <val2> -->\n        <div class=\"input-group col-xs-4\">\n          <!-- Text box for entering the filter text -->\n          <input type=\"text\" class=\"form-control dq-filter-1-text\" placeholder=\"table1.col1 * 3\">\n          <!-- Dropdown for selecting a column to add to filter -->\n          <div class=\"input-group-btn\">\n            <button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\"><span class=\"caret\"></span></button>\n            <ul class=\"dropdown-menu dropdown-menu-right\" role=\"menu\">\n"
    ...
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.columns : depth0),{"name":"each","hash":{},"fn":this.program(3, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
...
this["DataQ"]["templates"]["dq-grouping-modal"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "            <li class=\"dq-grouping-list-item sortable-placeholder\"\n              data-table=\""
    + alias2(alias1((depth0 != null ? depth0.table : depth0), depth0))
    + "\"\n              data-column_name=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.column : depth0)) != null ? stack1.name : stack1), depth0))
    + "\"\n              data-column_type=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.column : depth0)) != null ? stack1.type : stack1), depth0))
    + "\"\n              data-column_agg=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.column : depth0)) != null ? stack1.agg : stack1), depth0))
    + "\"\n              data-string=\""
    + alias2(alias1((depth0 != null ? depth0.string : depth0), depth0))
...
this["DataQ"]["templates"]["dq-modal-columns"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<!-- Create list of columns in the given table. This is used by the table modal -->\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.columns : depth0),{"name":"each","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"useData":true});
...
this["DataQ"]["templates"]["dq-selected-table"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<!-- Display a selected table in the main DataQ container -->\n<div class=\"row dq-contains-table-"
    + alias3(((helper = (helper = helpers.table_name || (depth0 != null ? depth0.table_name : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"table_name","hash":{},"data":data}) : helper)))
    ...
    + alias3(((helper = (helper = helpers.column_list || (depth0 != null ? depth0.column_list : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"column_list","hash":{},"data":data}) : helper)))
    + "</span>\n    </li>\n  </ul>\n</div>\n";
},"useData":true});
this["DataQ"]["templates"]["dq-sort-dropdown-li"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<li>\n<a href=\"#\" class=\"dq-sort-link\" data-columnname=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.column : stack1)) != null ? stack1.name : stack1), depth0))
    + "\" data-columntype=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.column : stack1)) != null ? stack1.type : stack1), depth0))
    + "\" data-aggregate=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.column : stack1)) != null ? stack1.agg : stack1), depth0))
    + "\" data-table=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.table : stack1), depth0))
    + "\" data-string=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.string : stack1), depth0))
    + "\">\n    "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.string : stack1), depth0))
    + "\n  </a>\n</li>\n";
},"useData":true});
this["DataQ"]["templates"]["dq-sort-list-item"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<li class=\"dq-sort-list-item\" data-columnname=\""
    ...
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.column : stack1)) != null ? stack1.type : stack1), depth0))
    + "\" data-aggregate=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.column : stack1)) != null ? stack1.aggregate : stack1), depth0))
    + "\" data-table=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.table : stack1), depth0))
    + "\" data-string=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.string : stack1), depth0))
...
this["DataQ"]["templates"]["dq-table-modal"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "          <h4 class=\"modal-title\">Update Columns in "
    + this.escapeExpression(((helper = (helper = helpers.table_name || (depth0 != null ? depth0.table_name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"table_name","hash":{},"data":data}) : helper)))
    + "</h4>\n";
  ...
  return "<div class=\"modal fade\" id=\"dq-table-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close dq-modal-quit\" data-dismiss=\"modal\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.table_name : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <div class=\"modal-body\">\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.table_name : depth0),{"name":"if","hash":{},"fn":this.program(5, data, 0),"inverse":this.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "        <ul class=\"dq-column-list\">\n        </ul>\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-primary dq-modal-done-btn\" data-dismiss=\"modal\">Done</button>\n      </div>\n    </div><!-- /.modal-content -->\n  </div><!-- /.modal-dialog -->\n</div><!-- /.modal -->\n";
},"useData":true});
